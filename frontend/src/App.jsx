          ...
          <div className="min-h-screen bg-background-primary flex flex-col">
            ...
            <main className="flex-1">
              <Routes>
                ...
                <Route path="/hr_staff/*" element={<HRStaffRoutes />} />
  ...
  return (
    <Routes>
      <Route element={<MainHRLayout />}>
        ...
        <Route
          path="HRReportingManagement"
          element={<HRReportingManagement />}
        />
        ...
        <Route
          path="feedback/:id/questions"
          element={<ViewSurveyQuestions />}
        />
        <Route
          path="feedback/:id/responses"
          element={<ViewResponsesWithQuestions />}
        />
...
const EmployeeRoutes = () => {
  return (
    <Routes>
      ...
      <Route
        path="viewleaveandattendance"
        element={<ViewLeaveAndAttendance />}
      />
