...
export default function ViewSurveyQuestions() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-[#F7FAFC] to-[#EEF2F7] overflow-hidden">
      ...
      {/* PAGE HEADER */}
      <div className="
        px-8 pt-6 pb-5 bg-white/80 backdrop-blur-md 
        shadow-[0_2px_10px_rgba(0,0,0,0.05)] border-b border-gray-200
      ">
        {/* Back Button */}
        <Link
          ...
          {survey.questions?.map((q, index) => (
            <div
              ...
              className="
                ...
                hover:-translate-y-1 hover:border-[#02C39A]/40
              "
            >
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  {q.options && (
                    <div className="mt-4">
                      <p className="text-sm text-[#9B9B9B] font-medium mb-2">
                        Options
                      </p>

                      <div
                        className="
                          bg-gradient-to-br from-[#F1FDF9] to-[#FFFFFF]
                          rounded-xl border border-[#02C39A]/20 p-4 shadow-sm
                        "
                      >
