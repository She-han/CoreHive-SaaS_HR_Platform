          ...
          if (response.success && response.data) {
            setOrganizationModules({
              ...
              moduleEmployeeFeedback:
                response.data.moduleEmployeeFeedback || false,
              moduleHiringManagement:
                response.data.moduleHiringManagement || false
            });
          }
        } catch (error) {
      ...
      case "ORG_ADMIN":
        return [
          ...
          },
          {
            ...
            current: location.pathname.startsWith(
              "/org_admin/departmentmanagement"
            )
          },
          {
      ...
      case "EMPLOYEE":
        return [
          ...
          },
          {
            ...
            current: location.pathname.startsWith(
              "/employee/viewleaveandattendance"
            )
          },
          {
            name: "Leave Request",
        ...
        >
            ...
            <div className="flex items-center">
              <div className="shrink-0">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #02C39A 0%, #05668D 100%)"
                  }}
                >
          ...
          {isCollapsed && (
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #02C39A 0%, #05668D 100%)"
              }}
            >
              <span className="text-white font-bold text-sm">CH</span>
            </div>
          ...
          {!isCollapsed ? (
            <div className="space-y-3">
              ...
              <button
                ...
                onMouseLeave={(e) =>
                  (e.currentTarget.style.backgroundColor = "#0C397A")
                }
              >
