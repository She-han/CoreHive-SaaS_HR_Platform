      ...
      >
        <Card
          className={`text-center relative h-full ${
            plan.popular ? "ring-2 ring-[#02C39A] shadow-xl" : "hover:shadow-lg"
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-text-secondary mt-2">{plan.employees}</p>
          </div>
          ...
          <ul className="space-y-3 mb-8 text-left">
            {plan.features.map((feature, featureIndex) => (
              ...
              >
                <CheckCircle
                  className="w-5 h-5 text-[#1ED292] mr-3 flex-shrink-0"
                  aria-hidden="true"
                />
                <span>{feature}</span>
              </motion.li>
