  ...
  return (
     <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' }}>
        <TrendingUp size={20} style={{ marginRight: '10px', color: '#4f46e5' }} />
        <h3 style={{ margin: 0, color: '#333' }}>Module Usage by Tenants</h3>
      </div>
      <p style={{ marginBottom: '25px', color: '#666' }}>Active module subscriptions</p>
        ...
        <div style={{ flex: 1, paddingLeft: '20px' }}>
          ...
          <div style={{
            ...
            <p style={{ 
              ...
              <strong>Employee</strong> module has the highest adoption rate with <strong>108</strong> active subscriptions.
            </p>
          </div>
        </div>
      </div>
...
export default ModuleUsagePieChart
