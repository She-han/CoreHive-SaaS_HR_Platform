        ...
        <div className="max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="text-center">
                ...
                <p className="text-text-secondary">
                  Select the modules that best fit your organization's needs.
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-sm text-text-secondary">
                  <p className="mb-2">
                    <strong>Basic Features:</strong> Employee Management,
                    Payroll, Leave Management, Attendance Tracking, Reports,
                    Notifications
                  </p>
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-text-secondary">
              Need help choosing? You can always modify these settings later in
