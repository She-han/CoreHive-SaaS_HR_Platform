...
export default function HeadcountReport() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 p-4 md:p-8 bg-[#F1FDF9]/30 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-4 md:mb-12">
        <div>
          <h2 className="text-3xl font-black text-[#0C397A] tracking-tight">
            Total Headcount
          </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 px-2">
            <Award className="text-[#0C397A]" size={20} />
