      ...
      {data ? (
              ...
              {data.attendance.map(([status, count]) => (
                ...
                >
                  ...
                  <div className="flex items-end justify-between">
                    <p className="text-3xl font-black text-[#0C397A]">
                      {count}
                    </p>
                    <ArrowUpRight
                      size={16}
                      className="text-[#1ED292] mb-1 opacity-0 group-hover:opacity-100 transition-opacity"
                    />
                  </div>
                </div>
              ))}
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 mt-8">
                  ...
                  <p className="text-sm text-blue-100/80 leading-relaxed">
                    ...
                    .
                    {data.newHires > 0
                      ? " New talent integrated successfully."
                      : " No new hires recorded."}
                  </p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-[2rem] p-20 border border-dashed border-[#9B9B9B]/30 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[#9B9B9B] text-sm max-w-xs mt-2">
            Choose a specific month and year to visualize attendance trends and
            hiring data.
          </p>
        </div>
      )}
