...
const HRStaffManagement = () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const availableDepts =
          deptList || departmentsRef.current || departments;
  ...
  const handleEditStaff = async (e) => {
    ...
    try {
      const apiData = hrStaffApi.formatHRStaffForAPI(formData);
      const response = await hrStaffApi.updateHRStaff(
        selectedStaff.id,
        apiData
      );
        ...
        <div className="flex flex-col sm:flex-row p-6 justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Manage HR staff members and their information
            </p>
          </div>
          <Button
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">
                        {selectedStaff.formattedDateOfJoining ||
                          new Date(
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="text-gray-900">
                      {selectedStaff.formattedSalary ||
                        `Rs. ${selectedStaff.basicSalary?.toLocaleString()}`}
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">
